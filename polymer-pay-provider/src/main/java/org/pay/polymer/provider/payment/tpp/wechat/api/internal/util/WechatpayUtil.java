...
import static org.pay.polymer.common.tpp.wechat.WechatConstants.SignType;
...
public class WechatpayUtil {
    ...
    public static String mapToXml(Map<String, String> data) throws Exception {
        ...
        try (StringWriter writer = new StringWriter()) {
            ...
            getLogger().warn("Invalid map, can not convert to XML. Error message: {}. map content: {}", ex.getMessage(), data);
            throw ex;
        }
        return output;
    }
