...
import org.pay.polymer.provider.payment.tpp.jdpay.api.response.JdpayTradeUnifiedPayMentResponse;
 ...
 * @since 2019-03-05
 */
public class JdpayTradeUnifiedPayMentRequest implements JdpayRequest<JdpayTradeUnifiedPayMentResponse> {
    ...
    @Override
    public Class<JdpayTradeUnifiedPayMentResponse> getResponseClass() {
        return JdpayTradeUnifiedPayMentResponse.class;
    }
