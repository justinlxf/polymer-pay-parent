...
import org.pay.polymer.provider.payment.tpp.wechat.api.response.WechatpayTradeCloseorderResponse;
 ...
 **/
public class WechatpayTradeCloseorderRequest implements WechatpayRequest<WechatpayTradeCloseorderResponse> {

    public WechatpayTradeCloseorderRequest() {

    }

    public WechatpayTradeCloseorderRequest(String serverUrl, String key, String bizContent) {
    ...
    @Override
    public Class<WechatpayTradeCloseorderResponse> getResponseClass() {
        return WechatpayTradeCloseorderResponse.class;
    }
