...
import org.pay.polymer.provider.payment.tpp.jdpay.api.response.JdpayTradeStripePayMentResponse;
 ...
 * @since 2019-03-05
 */
public class JdpayTradeStripePayMentRequest implements JdpayRequest<JdpayTradeStripePayMentResponse> {
    ...
    @Override
    public Class<JdpayTradeStripePayMentResponse> getResponseClass() {
        return JdpayTradeStripePayMentResponse.class;
    }
