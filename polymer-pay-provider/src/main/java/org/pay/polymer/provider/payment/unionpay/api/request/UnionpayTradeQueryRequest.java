 ...
 **/
public class UnionpayTradeQueryRequest implements UnionpayRequest<UnionpayTradeQueryResponse> {

    public UnionpayTradeQueryRequest() {
    }

    public UnionpayTradeQueryRequest(String serverUrl, String bizContent) {
    ...
    @Override
    public Class<UnionpayTradeQueryResponse> getResponseClass() {
        return UnionpayTradeQueryResponse.class;
    }
