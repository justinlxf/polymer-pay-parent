...
import org.pay.polymer.provider.payment.tpp.wechat.api.response.WechatpayTradeJsapiPayMentResponse;
 ...
 **/
public class WechatpayTradeJsapiPayMentRequest implements WechatpayRequest<WechatpayTradeJsapiPayMentResponse> {
    public WechatpayTradeJsapiPayMentRequest() {

    }

    public WechatpayTradeJsapiPayMentRequest(String serverUrl, String key, String bizContent) {
    ...
    @Override
    public Class<WechatpayTradeJsapiPayMentResponse> getResponseClass() {
        return WechatpayTradeJsapiPayMentResponse.class;
    }
