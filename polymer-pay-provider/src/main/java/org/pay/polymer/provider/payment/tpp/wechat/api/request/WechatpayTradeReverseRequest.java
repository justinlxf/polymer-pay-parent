...
import org.pay.polymer.provider.payment.tpp.wechat.api.response.WechatpayTradeReverseResponse;
 ...
 **/
public class WechatpayTradeReverseRequest implements WechatpayRequest<WechatpayTradeReverseResponse> {
    public WechatpayTradeReverseRequest() {
    }

    public WechatpayTradeReverseRequest(String serverUrl, String key, String certPath, String bizContent) {
    ...
    @Override
    public Class<WechatpayTradeReverseResponse> getResponseClass() {
        return WechatpayTradeReverseResponse.class;
    }
