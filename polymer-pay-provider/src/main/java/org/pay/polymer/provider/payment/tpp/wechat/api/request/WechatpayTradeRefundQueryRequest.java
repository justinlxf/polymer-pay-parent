...
import org.pay.polymer.provider.payment.tpp.wechat.api.response.WechatpayTradeRefundQueryResponse;
 ...
 **/
public class WechatpayTradeRefundQueryRequest implements WechatpayRequest<WechatpayTradeRefundQueryResponse> {

    public WechatpayTradeRefundQueryRequest() {
    }

    public WechatpayTradeRefundQueryRequest(String serverUrl, String key, String bizContent) {
    ...
    @Override
    public Class<WechatpayTradeRefundQueryResponse> getResponseClass() {
        return WechatpayTradeRefundQueryResponse.class;
    }
