 ...
 **/
public class UnionpayTradeCancelRequest implements UnionpayRequest<UnionpayTradeCancelResponse> {

    public UnionpayTradeCancelRequest() {
    }

    public UnionpayTradeCancelRequest(String serverUrl, String bizContent) {
    ...
    @Override
    public Class<UnionpayTradeCancelResponse> getResponseClass() {
        return UnionpayTradeCancelResponse.class;
    }
