...
import org.pay.polymer.provider.payment.tpp.wechat.api.response.WechatpayTradeDownloadbillResponse;
 ...
 **/
public class WechatpayTradeDownloadbillRequest implements WechatpayRequest<WechatpayTradeDownloadbillResponse> {

    public WechatpayTradeDownloadbillRequest() {
    }

    public WechatpayTradeDownloadbillRequest(String serverUrl, String key, String bizContent) {
    ...
    @Override
    public Class<WechatpayTradeDownloadbillResponse> getResponseClass() {
        return WechatpayTradeDownloadbillResponse.class;
    }
