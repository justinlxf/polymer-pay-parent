...
import org.pay.polymer.provider.payment.unionpay.api.response.UnionpayTradeUnifiedPayMentResponse;
 ...
 **/
public class UnionpayTradeUnifiedPayMentRequest implements UnionpayRequest<UnionpayTradeUnifiedPayMentResponse> {
    ...
    @Override
    public Class<UnionpayTradeUnifiedPayMentResponse> getResponseClass() {
        return UnionpayTradeUnifiedPayMentResponse.class;
    }
