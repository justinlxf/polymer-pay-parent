...
import org.pay.polymer.provider.payment.tpp.wechat.api.response.WechatpayTradeWapPayMentResponse;
 ...
 **/
public class WechatpayTradeWapPayMentRequest implements WechatpayRequest<WechatpayTradeWapPayMentResponse> {

    public WechatpayTradeWapPayMentRequest() {

    }

    public WechatpayTradeWapPayMentRequest(String serverUrl, String key, String bizContent) {
    ...
    @Override
    public Class<WechatpayTradeWapPayMentResponse> getResponseClass() {
        return WechatpayTradeWapPayMentResponse.class;
    }
