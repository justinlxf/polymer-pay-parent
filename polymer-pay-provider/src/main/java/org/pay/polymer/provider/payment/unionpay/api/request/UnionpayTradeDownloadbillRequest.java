 ...
 **/
public class UnionpayTradeDownloadbillRequest implements UnionpayRequest<UnionpayTradeDownloadbillResponse> {

    public UnionpayTradeDownloadbillRequest() {
    }

    public UnionpayTradeDownloadbillRequest(String serverUrl, String bizContent) {
    ...
    @Override
    public Class<UnionpayTradeDownloadbillResponse> getResponseClass() {
        return UnionpayTradeDownloadbillResponse.class;
    }
