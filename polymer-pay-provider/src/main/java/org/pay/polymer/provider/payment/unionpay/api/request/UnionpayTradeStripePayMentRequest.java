...
import org.pay.polymer.provider.payment.unionpay.api.response.UnionpayTradeStripePayMentResponse;
 ...
 **/
public class UnionpayTradeStripePayMentRequest implements UnionpayRequest<UnionpayTradeStripePayMentResponse> {

    public UnionpayTradeStripePayMentRequest() {
    }

    public UnionpayTradeStripePayMentRequest(String serverUrl, String bizContent) {
    ...
    @Override
    public Class<UnionpayTradeStripePayMentResponse> getResponseClass() {
        return UnionpayTradeStripePayMentResponse.class;
    }
