...
import org.pay.polymer.provider.payment.tpp.wechat.api.response.WechatpayTradeQRCodePayMentResponse;
 ...
 **/
public class WechatpayTradeQRCodePayMentRequest implements WechatpayRequest<WechatpayTradeQRCodePayMentResponse> {

    public WechatpayTradeQRCodePayMentRequest() {

    }

    public WechatpayTradeQRCodePayMentRequest(String serverUrl, String key, String bizContent) {
    ...
    @Override
    public Class<WechatpayTradeQRCodePayMentResponse> getResponseClass() {
        return WechatpayTradeQRCodePayMentResponse.class;
    }
