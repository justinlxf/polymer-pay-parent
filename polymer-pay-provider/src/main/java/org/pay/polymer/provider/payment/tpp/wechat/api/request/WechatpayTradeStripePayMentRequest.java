...
import org.pay.polymer.provider.payment.tpp.wechat.api.response.WechatpayTradeStripePayMentResponse;
 ...
 **/
public class WechatpayTradeStripePayMentRequest implements WechatpayRequest<WechatpayTradeStripePayMentResponse> {

    public WechatpayTradeStripePayMentRequest() {

    }

    public WechatpayTradeStripePayMentRequest(String serverUrl, String key, String bizContent) {
    ...
    @Override
    public Class<WechatpayTradeStripePayMentResponse> getResponseClass() {
        return WechatpayTradeStripePayMentResponse.class;
    }
