...
import org.pay.polymer.provider.payment.tpp.jdpay.api.response.JdpayTradeOnlinePayMentResponse;
 ...
 * @since 2019-03-05
 */
public class JdpayTradeOnlinePayMentRequest implements JdpayRequest<JdpayTradeOnlinePayMentResponse> {
    ...
    @Override
    public Class<JdpayTradeOnlinePayMentResponse> getResponseClass() {
        return JdpayTradeOnlinePayMentResponse.class;
    }
